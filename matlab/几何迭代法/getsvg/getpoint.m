...
function R=getpoint(svgname,L,pointnum,graph)
        ...
        otherwise
            if sta(end)=='M'
                if P_line_inuse{num_row-1}=='M'
                    ...
                    lLong=sum(vecnorm(diff(l),2,2));
                    fine=L/lLong/pointnum;
                    clear l
                    l=svgl(fine,p0,p1);
...
%                     p_por_origin=p1;
            ...
            elseif sta(end)=='C'
                ...
                bLong=sum(vecnorm(diff(b0123),2,2));
%                 fine=L/bLong/pointnum;
%                 getnum=bLong*pointnum/L;
                fine=1/floor(bLong*pointnum/L);
                clear b0123
                b0123=svgc(fine,p0,p1,p2,p3);
