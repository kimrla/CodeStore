...
%% 合成
A = LSMatrix_V(k,N,T);           % V-系统基函数在采样节点向量上的取值(基对于列)
Vdiscrete = A * Lambda;     
...
for s = 1 : NumSeg
    ...
    switch NumDim
        case 1
            plot(ts,ys,'Color',[0 102 153]/255,'LineWidth',3);hold on
        case 2
            plot(ys(:,1),ys(:,2),'Color',[0 102 153]/255,'LineWidth',3);hold on
        case 3
            plot(ys(:,1),ys(:,2),ys(:,3),'Color',[0 102 153]/255,'LineWidth',3);hold on
    end
end
