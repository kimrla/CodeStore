function GNFerr3D(tzloc,errV,errP,errf,errdb4,errcoif3,errsym5) %分别传入特征点序号，后边的是每种方法每个点的误差
figure
...
set(gca,'ytick',[1:6],'yticklabel',{'本文方法','PIA','Fourier','Db4','Coif3','Sym5'},'linewidth', 1.1, 'fontsize', 10, 'fontname', '微软雅黑')
end