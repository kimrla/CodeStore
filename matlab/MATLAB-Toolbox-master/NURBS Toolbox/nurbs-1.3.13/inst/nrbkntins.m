...
if ~strcmp(nurbs.form,'B-NURBS') && ~strcmp(nurbs.form,'Bezier')% NOTICE: add Bezier form.&& ~strcmp(nurbs.form,'Bezier')
  error('Not a recognised NURBS or Bezier representation');
end
