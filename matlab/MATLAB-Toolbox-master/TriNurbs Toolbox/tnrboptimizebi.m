function tsrf=tnrboptimizebi(tsrf, p2t2, pfix, dt, it, h0, k0, method)

% tnrboptimize: Optimize the triangles of a tri-nurbs surface by method of bisection
% 
% Calling Sequences:
% 
...
for k=1:it
    for i=1:np
        ...
        [x2, X2]=nrbsrfreversebi(srf, x1, X2);
...
% tsrf=tnrboptimizebi(tsrf, p2t2, pfix, dt, it, h0, k0);
% 
% % Plot results
% figure; hold on; 
% tnrbplot(tsrf);
