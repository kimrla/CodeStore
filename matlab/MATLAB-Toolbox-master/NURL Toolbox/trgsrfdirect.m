...
% Rearrange the direction (axis) of a triangular nurl patch for subsequent manipulations.
% 
% Calling Sequences:
% 
...
%               du = 1 means v axis points to the focus point 
%
