function [G, Gs, Gt, S, T]=nrltrgmat(bsrf, tt)

% Get first derivatives of the nrl basis matrix in area coordinates of a triangle
% 
%  INPUT:
%
...
crvs=bsrf.edges; crv2=crvs(2); crv3=crvs(3);
